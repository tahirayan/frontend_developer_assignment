            ...
            <div className={styles.sideBarWrapper}>
                ...
                <nav className={styles.nav}>
                    ...
                    <div className={styles.panel}>
                        <div><img src={right} alt={""} /><a href={"https://www.linktera.com.tr/"} className={styles.links}>Linktera Websitesi</a></div>
                        <div><img src={right} alt={""} /><a href={"https://www.linkedin.com/company/linktera/"} className={styles.links}>LinkedIn Hesabı</a></div>
                ...
                <div className={styles.logout}>
                    <p>Çıkış</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="23.238" height="33.977" viewBox="0 0 23.238 33.977">
                    <path id="Path_6" d="M161.949,487.4v27.618l16,6.359V492.443H165.019v-1.754h15.125v24.33h5.042V487.4Zm5.563,14.509a.79.79,0,0,1,.791-.789h2.132a.794.794,0,0,0,.791-.791.79.79,0,0,1,1.345-.563l3.353,3.326-3.353,3.324a.777.777,0,0,1-.552.23.788.788,0,0,1-.793-.793.79.79,0,0,0-.791-.789H168.3a.79.79,0,0,1-.791-.789Z" transform="translate(-161.949 -487.401)" fill="#fff"/>
                </svg>
                </div>
            </div>
        </div>
